            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={targetPath}
                  className={`relative px-4 py-2 text-sm font-semibold whitespace-nowrap transition-all duration-300 rounded-full ${isActive
                ...
                <div className="absolute right-0 mt-2 w-40 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50 animate-fade-in">
                  {[
                    ...
                    <button
                      ...
                      className={`group w-full px-4 py-3 text-left flex items-center gap-3 transition-colors ${locale === lang.code
            ...
            {navItems.map((item, index) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={targetPath}
                  className={`block px-6 py-3.5 text-base font-bold whitespace-nowrap transition-all duration-300 border-l-4 animate-fade-in ${isActive
                  ...
                  <div className="absolute left-0 right-0 bottom-full mb-2 bg-white rounded-xl shadow-2xl overflow-hidden z-50 animate-fade-in">
                    {[
                      ...
                      <button
                        ...
                        className={`group w-full px-4 py-4 text-left flex items-center gap-3 transition-colors border-b border-gray-100 last:border-b-0 ${locale === lang.code
                            ? 'bg-[#E8F2F9] text-[#2C5282] font-bold'
                            : 'text-gray-700 hover:bg-[#E8F2F9] hover:text-[#4681BC]'
                          }`}
                      >
